...
答え： その通り！これもある種の問題群に対する計算効率の限界に関する予想である．ただし，正確には「Ｐ≠ＮＰ予想」と呼ぶべき．予想は≠なので．（これについての簡単な解説は別ページＰ≠ＮＰ予想[（入り口）](./lab/PvsNPintro-jp.html)にまとめました．）
...
### そもそも量子力学とは？
量子力学とは粒子の振舞いを説明するための物理の理論である．量子力学が一般的に非直感的だと考えられている理由は，ほとんど全ての場合「**非局所性**」という性質に起因する．
次の問題を考えよう．

<div style="margin-left: 2em;" markdown="1">
  同じ町に住んでいるアリスさんとボブくんは毎日同じ時間に公園へ犬の散歩に行く．公園は2つあり一回の散歩で訪れる公園は1つだけである．
...
この問題について「ペットシッターは $$2^n$$ ビット送らなくてはいけない」というのが情報因果律の要請である．
