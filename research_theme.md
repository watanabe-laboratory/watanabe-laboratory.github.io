...
当研究室では理論計算機科学で培われたテクニックを駆使して，量子力学を超えた理論の解析をしたり，逆に量子力学を超えた理論の考え方を用いて理論計算機科学の定理を証明したりしている．
世界的にとてもホットな分野であるが，理論計算機科学の最先端の道具を使っている研究グループは当研究室以外には，まだほとんど存在しない．
