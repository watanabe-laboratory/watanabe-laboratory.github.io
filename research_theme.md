...
しかし，量子状態という不思議なリソースを共有していれば犬条件が満たされる確率を $$(2+\sqrt{2})/4 \approx 0.854$$ にすることができる．
...
### 「計算」の活躍
量子力学とは犬条件が満たされる確率，以降犬確率と呼ぶことにする，を $$(2+\sqrt{2})/4 \approx 0.854 $$ にできる理論であった．
何故犬確率はこのような中途半端な値なのだろう？
犬確率が 0.9 や 1 であったら何か理論が破綻するのだろうか？
これが「量子力学の特徴付け」の問題である．
2009年に「**情報因果律**」という原理が提案され，犬確率が $$(2+\sqrt{2})/4$$ を超えると情報因果律が破れることが明らかになった．
